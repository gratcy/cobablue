                ...
                <!-- Build page from here: Usual with <div class="row"></div> -->
                    ...
                    <div class="row">
                        ...
                        <div class="switch-lang">
                          <ul class="clearenter">
                            <li class="text switch-en">Switch language to :</li>
                            <li class="text switch-id">Ganti bahasa ke:</li>
                            <li class="button" id="button-en">
                              <a href="javascript:void(0)" class="clearenter btn btn-default">
                                <img src="<?php echo site_url('application/views/panel/assets/images/tutorial-topup/english.png'); ?>" />
                                <b>English</b>
                              </a>
                            </li>
                            <li class="button" id="button-id">
                              <a href="javascript:void(0)" class="clearenter btn btn-default">
                                <img src="<?php echo site_url('application/views/panel/assets/images/tutorial-topup/indonesia.png'); ?>" />
                                <b>Indonesia</b>
                              </a>
                            </li>
                          </ul>
						...
						<script type="text/javascript" src="<?php echo site_url('application/views/panel/assets/js/tutorial-topup.js'); ?>"></script> 
