...
class Transaction_model extends CI_Model {
    ...
    function __get_transaction($uid) {
		return "SELECT a.tid,a.tno,a.tdate,a.tfrom,a.tto,a.ttotal,a.ttotalhash,a.tapiinv,a.tduedate,a.tstatus,a.tpoint,b.ptype,b.pname FROM transaction_tab a LEFT JOIN product_tab b ON a.tpid=b.pid WHERE a.tstatus!=3 AND a.tuid=" . $uid . " ORDER BY a.tid DESC";
	}
